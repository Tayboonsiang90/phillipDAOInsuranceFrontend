    ...
    return (
        <React.Fragment>
            ...
            <div className="d-flex flex-column justify-content-center">
                ...
                <h3 className="font-alert">{currentAccountAddress} is a whitelisted damage assessor.</h3>
                <h1 className="font-fancy p-3">Claims waiting for damage assessment</h1>
                            ...
                            <div className="accordion-body">
                                <div className="row">
                                    ...
                                    <div className="col-3 d-flex flex-column justify-content-center">
                                        <div>Assessed Damages</div>
                                        <input type="number" class="form-control" placeholder="$10000"></input>
